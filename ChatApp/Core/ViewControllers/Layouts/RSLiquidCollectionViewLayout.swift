//
//  RSLiquidCollectionViewLayout.swift
//  NewsReader
//
//  Created by Richard Stewart on 3/21/17.
//

import UIKit

public protocol RSLiquidLayoutDelegate: class {
    func collectionView(collectionView: UICollectionView, heightForCellAtIndexPath indexPath: IndexPath, width: CGFloat) -> CGFloat
    func collectionViewCellWidth(collectionView: UICollectionView) -> CGFloat
}

public class RSLiquidCollectionViewLayout: RSCollectionViewFlowLayout {
