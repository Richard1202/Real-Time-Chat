//
//  RSDrawerController.swift
//  AppTemplatesFoundation
//
//  Created by Richard Stewart on 2/10/17.

//

import UIKit

class RSDrawerController: UIViewController, RSNavigationControllerDelegate {
    var rootViewController: RSNavigationController
    var menuController: RSMenuCollectionViewController
    var isMenuExpanded: Bool = false
    let overlayView = UIView()

    init(rootViewController: RSNavigationController, menuController: RSMenuCollectionViewController) {
