//
//  RSGenericFirebaseDataSource.swift
//  ShoppingApp
//
//  Created by Richard Stewart on 10/15/17.
//
...
class RSGenericFirebaseDataSource<T: RSGenericBaseModel & RSGenericFirebaseParsable>: RSGenericCollectionViewControllerDataSource {
